...
def load_clip_to_cpu(cfg):
    ...
    elif 'quickgelu' in backbone_name:


        model, _, preprocess = open_clip.create_model_and_transforms(backbone_name,
...
te_transform_clip = transforms.Compose([
...
# tr_transforms = TwoCropsTransform(te_transform_clip, get_random_transform(224))
tr_transforms = te_transform_clip
