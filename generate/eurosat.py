...
for k, v in category_list_all.items():
    ...
    for i, category in enumerate(tqdm(v)):
        ...
        prompts.append("Explore any seasonal changes depicted in the satellite imagery of " + category + ".")
        prompts.append("Describe the color palette present in the satellite picture of " + category + ".")
        prompts.append("In what ways can the satellite view aid in monitoring changes in " + category + "?")
        prompts.append("Discuss the spatial arrangements visible in the satellite photograph of " + category + ".")
        ...
        prompts.append("Describe the overall composition and layout captured in the satellite photo of " + category + ".")
        prompts.append("Discuss the significance of " + category + " in the context of environmental monitoring using satellite data.")
        prompts.append("What human-made structures stand out in the satellite imagery of " + category + "?")
        ...
        prompts.append("Describe the satellite imagery features that help recognize " + category + " accurately.")
        prompts.append("Discuss any challenges in identifying " + category + " from satellite data.")
        ...
        prompts.append("What role does the satellite data play in assessing the land cover dynamics of " + category + "?")
